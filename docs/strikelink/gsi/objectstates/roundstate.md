...
```csharp
public class RoundState : StrikeLink.GSI.IGsiPayload, System.IEquatable`1[[StrikeLink.GSI.ObjectStates.RoundState, StrikeLink, Version=1.2.0.0, Culture=neutral, PublicKeyToken=null]]
```
