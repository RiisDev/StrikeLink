...
```csharp
public class SteamPlayer : System.IEquatable`1[[StrikeLink.Services.WebService.SteamPlayer, StrikeLink, Version=1.2.0.0, Culture=neutral, PublicKeyToken=null]]
```
