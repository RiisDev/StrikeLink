...
internal sealed class LinuxChromiumKeyProvider
{
	...
	internal static byte[] DeriveKey(byte[] passwordBytes)
	{
		return Rfc2898DeriveBytes.Pbkdf2(passwordBytes, PbkdfSalt, PbkdfIterations, HashAlgorithmName.SHA1, KeyLengthBytes);
	}
